...
<form  method="post" enctype="multipart/form-data">
    ...
    <input type="file" class="thomas" name="imageFile" enctype="multipart/form-data"><br><br>

    <h2 class="opa">Enviar PDF</h2><br><br>
    <input type="file" class="thomas" name="fileToUpload" id="fileToUpload" required><br><br>
